...
import time
import urllib2
from bottle import route, run, template, get, post, request, redirect, error, static_file
...
ipaddr = f.readline()
dns = 'http://ec2-' + ipaddr + '.compute-1.amazonaws.com:8080'
f.close()
...
@error(404)
def error404(error):
    return 'The Page or file you are looking for do not exist. <br> Please visit <a href=' + dns + '> Vrisko </a> for a new search.'
